...
The last version with full 32-bit (i686) support was v2.40.x. After that, 32-bit installers continued to be offered with reduced component updates; the last version to ship with the 32-bit installer, Portable Git and archive was [v2.48.1](https://github.com/git-for-windows/git/releases/tag/v2.48.1.windows.1). Since then, the only official 32-bit artifact is [MinGit](https://gitforwindows.org/mingit.html), a minimal subset intended for third-party applications. For details, see the [32-bit support timeline](https://gitforwindows.org/32-bit.html).
