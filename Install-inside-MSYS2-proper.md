...
To integrate with the Windows Credential Manager, install the package `git-credential-manager`, then tell git to use it with `git config --global credential.helper manager`.
